...
class MemberSearch extends Member
{
    ...
    {
        return [
            [['username', 'password', 'member_title', 'member_name', 'member_mobile', 'member_email', 'member_edu', 'member_status', 'member_date'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['like', 'member_title', $this->member_title])
            ...
            ->andFilterWhere(['like', 'member_edu', $this->member_edu])
