...
<div class="card shadow mb-5">
    ...
    <div class="card-footer clearfix">
        <?= Html::submitButton($model->isNewRecord ? Yii::t('app', '<i class="fas fa-check"></i> บันทึก') : Yii::t('app', '<i class="fas fa-check"></i> แก้ไข'), ['class' => $model->isNewRecord ? 'btn btn-sm btn-success float-left link-loading shadow' : 'btn btn-sm btn-info float-left link-loading shadow']) ?>
        &nbsp;
